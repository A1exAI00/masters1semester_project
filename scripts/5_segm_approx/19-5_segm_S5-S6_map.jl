...
v₀_start, v₀_end, v₀_N = -0.25, NEC1S1763_5segm_approx.I_4/NEC1S1763_5segm_approx.I_1, 10
...
NEC1S1763_5segm_approx.display_params(obl6)
# println(obl6.is_λ_real)
# println((obl6.u_st, obl6.v_st))
# println(obl6.C₁(1.0,0.5))
# println(obl6.C₂(1.0,0.5))

u₀ = obl6.u_max_bound
u_L_end = obl6.u_min_bound

#########################################################################################

function L_calc_τ(v₀)
    u(t) = obl6.sol_u(obl6.C₁(u₀,v₀), obl6.C₂(u₀,v₀), t)
    v(t) = obl6.sol_v(obl6.C₁(u₀,v₀), obl6.C₂(u₀,v₀), t)
    f(τ,p) = u(τ) - u_L_end
...
plot!(p1, [obl6.u_st], [obl6.v_st], seriestype=:scatter, label=nothing)


p = plot(p1, legend=false, size=(500,400), dpi=300)

savedir = joinpath("tmp", "19-5_segm_S5-S6_map")
savepath = plotsdir(savedir, "19-5_segm_S5-S6_map_$(time_ns()).pdf")
savefig(p, savepath)