...
v₀_start, v₀_end, v₀_N = segm_3_model.I_v./segm_3_model.I_p, 1.0, 10
...
function L₃_sol_integration(v₀)
    sol = segm_3_model.all_obl_integrate([u₀, v₀], t_span, 3; saveat=t_range)
    return sol
end
...
plot!(p1, [segm_3_model.u₀_st_3], [segm_3_model.v₀_st_3], label="", seriestype=:scatter, ms=2)
